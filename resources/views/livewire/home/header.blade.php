      ...
      <div class="flex items-center gap-x-5 lg:gap-x-10 text-orange-200">
        ...
        <div class="login flex">
          <a href="#" class="flex items-center gap-x-2.5">
            ...
            <span
              class="hidden xxl:inline-block font-dana-B text-xl pl-10 tracking-tightest"
              >ورود | ثبت نام</span
            >
          </a>
        </div>
      ...
      <nav class="flex gap-x-4 md:gap-x-9 items-center h-14">
        ...
        >
          ...
          <li class="relative group">
            ...
            >
            <div
              class="absolute p-6 w-52 opacity-0 invisible group-hover:opacity-100 group-hover:visible bg-white dark:bg-zinc-700 rounded-2xl border-t-orange-300 border-t-[3px] dark:text-white text-zinc-700 tracking-normal space-y-4 transition-all child:inline-block font-normal child:transition-color child-hover:text-orange-300 top-full delay-75 font-dana-Med text-base"
            >
              <a href="#">قهوه ویژه</a>
