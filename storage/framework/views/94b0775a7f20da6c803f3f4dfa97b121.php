                                ...
                                <form role="form" wire:submit.prevent='UserForm'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3 mt-30">
                                            ...
                                            <?php if($profilePhoto): ?>
                                                <img class="form-control mt-3 mb-3" src="<?php echo e($profilePhoto->temporaryUrl()); ?>"
                                                    alt="">
                                            <?php endif; ?>
...
<?php /**PATH E:\Becafe\Becofe\resources\views\livewire\admin\users\edit.blade.php ENDPATH**/ ?>