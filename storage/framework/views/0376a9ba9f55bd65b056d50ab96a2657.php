        ...
        <div class="col-lg-4 col-md-6 col-xs-12 mx-auto">
            <div class="account-box">
                ...
                <div class="account-footer">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn-link-register">وارد شویــد</a>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH E:\Becafe\Becofe\resources\views\livewire\home\users\register.blade.php ENDPATH**/ ?>