<?php $__env->startSection('title', 'سطل زباله برند ها'); ?>
<div>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($brand->deleted_at); ?></td>
                                                    <td>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-brands-restore')): ?>
                                                            <button wire:click="restore(<?php echo e($brand->id); ?>)"
                                                                class="action-icon">
                                                                <i class="zmdi zmdi-replay zmdi-custom"></i></button>
                                                        <?php endif; ?>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-brands-forceDelete')): ?>
                                                            <button wire:click="deleteId(<?php echo e($brand->id); ?>)"
                                                                wire:click="deleteId(<?php echo e($brand->id); ?>)"
...
<?php /**PATH E:\Becafe\Becofe\resources\views\livewire\admin\products\brands\trash.blade.php ENDPATH**/ ?>