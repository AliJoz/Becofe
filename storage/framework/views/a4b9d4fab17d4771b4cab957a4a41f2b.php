<?php $__env->startSection('title','شبکه های اجتماعی فوتر'); ?>
<div>
                                    ...
                                    <div class="ibox-content mailbox-content">
                                        <div class="file-manager clearfix">
                                            ...
                                            <ul class="folder-list">
                                                <li><a href="<?php echo e(route('admin.settings.footer.label')); ?>"> برچسب ها </a></li>
                                                <li class="active"><a href="<?php echo e(route('admin.settings.footer.social')); ?>"> شبکه های اجتماعی </a></li>
                                                <li><a href="<?php echo e(route('admin.settings.footer.logo')); ?>"> لوگوهای فوتر </a></li>
                                            </ul>
...
<?php /**PATH E:\Becafe\Becofe\resources\views\livewire\home\admin\settings\footer\social.blade.php ENDPATH**/ ?>