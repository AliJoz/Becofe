<?php $__env->startSection('title', 'لوگو های فوتر'); ?>
<div>
                                                                    ...
                                                                    <tbody>
                                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $logos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <!--[if BLOCK]><![endif]--><?php if($logo->isActive == 1): ?>
                                                                                        <a wire:click="changeStatus(<?php echo e($logo->id); ?>)"
...
<?php /**PATH E:\Becafe\Becofe\resources\views/livewire/home/admin/settings/footer/logo.blade.php ENDPATH**/ ?>